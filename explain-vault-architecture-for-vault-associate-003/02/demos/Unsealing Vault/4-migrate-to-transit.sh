...
podman container stop vault-basic

# Attach to the vault-network
podman network connect vault-network vault-basic
...
podman container start vault-basic
